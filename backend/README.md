...
## Project Structure
    ...
    ├── testapiautoteammem_110129  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_110129`
...
2. Clone this repo and `cd testapiautoteammem_110129`
